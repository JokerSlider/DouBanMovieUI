...
typedef void(^CropViewDidFininshCroppingImageBlock)(PECropViewController *controller, UIImage *croppedImage, CGAffineTransform transform, CGRect cropRect);
typedef void(^CropViewDidCancelBlock)(PECropViewController *controller);
...
@property (nonatomic, copy) CropViewDidFininshCroppingImageBlock cropViewDidFininshCroppingImageBlock;

@property (nonatomic, copy) CropViewDidCancelBlock cropViewDidCancelBlock;
