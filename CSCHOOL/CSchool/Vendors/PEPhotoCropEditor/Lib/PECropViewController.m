...
- (void)cancel:(id)sender
{
    ...
    }else if (_cropViewDidCancelBlock){
        _cropViewDidCancelBlock(self);
    }
}
...
- (void)done:(id)sender
{
    ...
    }else if (_cropViewDidFininshCroppingImageBlock){
        _cropViewDidFininshCroppingImageBlock(self, self.cropView.croppedImage, self.cropView.rotation, self.cropView.zoomedCropRect);
    }
}
