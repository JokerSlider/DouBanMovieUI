...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.commitBar.tintColor = [UIColor blackColor];
//        [self.commitBar setTitleTextAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15],NSForegroundColorAttributeName : [UIColor blackColor]} forState:UIControlStateNormal];
        ...
        self.cancelBar.tintColor = [UIColor blackColor];
//        [self.cancelBar setTitleTextAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15],NSForegroundColorAttributeName : [UIColor blackColor]} forState:UIControlStateNormal];

        self.titleBar = [[UIBarButtonItem alloc] initWithTitle:@"提示" style:UIBarButtonItemStyleDone target:self action:nil];
