...
//#define KTableViewMaxHeight Main_Screen_Height-200
#define KTableViewMaxHeight Main_Screen_Height-40-64

#define KTopButtonHeight 0
...
@property (nonatomic,strong) AllEmployButton *leftButton;
...
- (void)_setButton{
//    self.leftButton = [AllEmployButton  buttonWithType:UIButtonTypeCustom];
//    self.leftButton.frame = CGRectMake(0, 0, Main_Screen_Width, KTopButtonHeight);
...
- (void)reloadLeftTableView{
    ...
    [self.leftTableView_1 selectRowAtIndexPath:selIndex animated:YES scrollPosition:UITableViewScrollPositionTop];
...
- (UITableView *)leftTableView_1{
    ...
    if (!_leftTableView_1) {
        ...
        _leftTableView_1.backgroundColor = [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0];//[UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1.0];
        _leftTableView_1.tableFooterView = [[UIView alloc]init];
        _leftTableView_1.separatorColor = [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0];
...
- (UITableView *)leftTableView_2{
    if (!_leftTableView_2) {
        ...
        _leftTableView_2.backgroundColor = [UIColor whiteColor];//[UIColor colorWithRed:243/255.0 green:243/255.0 blue:243/255.0 alpha:1.0];
        _leftTableView_2.tableFooterView = [[UIView alloc]init];
        _leftTableView_2.separatorColor = [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0];
...
- (UITableView *)rightTableView{
    ...
    if (!_rightTableView) {
        ...
        _rightTableView.separatorColor = [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.selectedBackgroundView.backgroundColor =  [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1.0];
    ...
    if (!ifFind) {
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(cell.contentView.bounds.size.width-1, 0, 0.5, cell.contentView.bounds.size.height)];
...
//    cell.contentView.layer.borderColor = [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0].CGColor;
