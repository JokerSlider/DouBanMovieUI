...
-(void)loadComboBoxView{
    ...
    [comBoxBtn setImage:[UIImage imageNamed:@"down"] forState:UIControlStateNormal];
    [comBoxBtn setImage:[UIImage imageNamed:@"down"] forState:UIControlStateSelected];
...
//        [btn addTarget:self action:@selector(comBoxBtnClick:) forControlEvents:UIControlEventTouchUpInside];
