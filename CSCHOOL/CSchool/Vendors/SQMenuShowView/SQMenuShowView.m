...
- (id)initWithFrame:(CGRect)frame items:(NSArray<NSArray *> *)items showPoint:(CGPoint)showPoint{
    ...
    if (self) {
        ...
        NSArray *itemArray = items[0];
        newFrame.size.height = itemArray.count *itemHeigth+triangleWith-5;
        self.frame = newFrame;
        self.alpha = 0;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textTitle.text = self.items[0][indexPath.row];
    cell.logoImageView.image = [UIImage imageNamed:self.items[1][indexPath.row]];
