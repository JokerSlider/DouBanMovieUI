...
- (void)commonInit
{
    ...
    {
        _dotView = [UIButton buttonWithType:UIButtonTypeCustom];
...
//    _textLabel.frame = self.bounds;
    _textLabel.frame = CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height-20);
...
//    sizeDot = roundf(sizeDot);
    ...
    CGFloat dotwith = 20;
    _dotView.frame = CGRectMake(0, 0, dotwith, dotwith);
    _dotView.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.)+10);
//    _dotView.layer.cornerRadius = dotwith / 2.;
}
