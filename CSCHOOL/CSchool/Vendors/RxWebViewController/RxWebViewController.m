...
//        theTitle = [[theTitle substringToIndex:20] stringByAppendingString:@"…"];
//    }
    self.title = theTitle;
...
-(UIBarButtonItem*)closeButtonItem{
    if (!_closeButtonItem) {
        _closeButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:@selector(closeItemClicked)];
    }
