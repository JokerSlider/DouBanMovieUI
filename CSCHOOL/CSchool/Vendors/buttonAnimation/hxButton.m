...
- (void)initSettingWithColor{
    ...
    baseView *hxView = [[baseView alloc] initWithFrame:CGRectZero];
    self.hxView = hxView;
    self.hxView.bounds = CGRectMake(0, 0, defaultH*0.8, defaultH*0.8);
    self.hxView.tintColor = [UIColor whiteColor];
    self.hxView.lineWidth = 2;
    self.hxView.center = CGPointMake(CGRectGetMidX(self.layer.bounds), CGRectGetMidY(self.layer.bounds));
    self.hxView.translatesAutoresizingMaskIntoConstraints = NO;
    self.hxView.userInteractionEnabled = NO;
    [self addSubview:self.hxView];
...
-(void)setBackgroundColor:(UIColor *)backgroundColor
{
    ...
    [self.forDisplayButton setBackgroundImage:[[self imageWithColor:_backgroundColor cornerRadius:3] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)] forState:UIControlStateNormal];
    self.contentColor = _backgroundColor;
    self.hxView.backgroundColor= _backgroundColor;
...
-(void)setProgressColor:(UIColor *)progressColor{
    ...
    self.hxView.tintColor = progressColor;
}
