//
//  UserPhoneInput3ViewController.m
//  CSchool
//
//  Created by 左俊鑫 on 2017/8/25.
...
@interface UserPhoneInput3ViewController ()
...
@implementation UserPhoneInput3ViewController
...
- (void)createViews{
    ...
    noticeLabel.text = _showInfoDic[@"trip3"];;
...
- (void)sendMsgCodeAction:(JKCountDownButton *)sender{
    ...
    if ([[AppUserIndex GetInstance].yanzhengPhoneArray[0] isEqualToString:_usernameTextField.text] || [[AppUserIndex GetInstance].yanzhengPhoneArray[1] isEqualToString:_usernameTextField.text]) {
