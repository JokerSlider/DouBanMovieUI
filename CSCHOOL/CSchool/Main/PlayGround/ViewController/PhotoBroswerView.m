...
@interface PhotoBroswerView ()<SDPhotoBrowserDelegate>

@property (nonatomic, strong) NSArray *imageViewsArray;
@property (nonatomic ,strong)  UIImageView *LoopimageView;
@end

@implementation PhotoBroswerView
...
- (void)setup
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        _LoopimageView.userInteractionEnabled = YES;
...
//            itemH = image.size.height / image.size.width * itemW;
    ...
    [_picArray enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        //---------------------------------------临时-----------------------------------//
        NSString *urlStr = [obj stringByReplacingOccurrencesOfString:_breakString  withString:@""];
