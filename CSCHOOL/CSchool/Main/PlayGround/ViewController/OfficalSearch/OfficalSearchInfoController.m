...
@interface OfficalSearchInfoController ()<UIWebViewDelegate,UITableViewDataSource,UITableViewDelegate,XGAlertViewDelegate>
{
...
@implementation OfficalSearchInfoController
...
-(void)loadData
{
    ...
    WEAKSELF;
    [NetworkCore requestPOST:[AppUserIndex GetInstance].API_URL parameters:@{@"rid":@"getDocumentInfoById",@"id":_newsID} success:^(NSURLSessionDataTask * _Nullable task, id  _Nullable responseObject) {
        [ProgressHUD dismiss];
