...
//
//+ (PYOption *)basicColumnOptionwithDic:(NSDictionary *)dic {
//    NSArray *titleArr = dic[@"data"];
//    NSArray *xxisArr = dic[@"lenged"];
//
//    //2013-2014 第一学期,
//    //2013-2014 第二学期,
//    //2014-2015 第一学期,
...
//            title.textEqual(nil).subtextEqual(nil);
//        }])
//        .gridEqual([PYGrid initPYGridWithBlock:^(PYGrid *grid) {
//            grid.xEqual(@50).x2Equal(@10);
//        }])
//        .tooltipEqual([PYTooltip initPYTooltipWithBlock:^(PYTooltip *tooltip) {
//            tooltip.triggerEqual(PYTooltipTriggerAxis);
//        }])
//        .legendEqual([PYLegend initPYLegendWithBlock:^(PYLegend *legend) {
//            legend.dataEqual(titleArr);
//        }])
...
//            series.nameEqual([titleArr firstObject])
//            .typeEqual(PYSeriesTypeBar)
//            .addDataArr([dic[@"series"] objectForKey:[titleArr firstObject]]);
//        }])
//        .addSeries([PYCartesianSeries initPYSeriesWithBlock:^(PYSeries *series) {
//            series.nameEqual([titleArr lastObject])
//            .typeEqual(PYSeriesTypeBar)
//            .addDataArr([dic[@"series"] objectForKey:[titleArr lastObject]]);
//        }]);
//    }];
//}
//
