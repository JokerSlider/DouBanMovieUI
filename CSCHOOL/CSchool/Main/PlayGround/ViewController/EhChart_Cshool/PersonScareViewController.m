...
@interface PersonScareViewController ()
//@property(nonatomic, strong) PYEchartsView *kEchartView;

@end

@implementation PersonScareViewController
...
-(void)loadData
{
//    [NetworkCore requestPOST:API_HOST3 parameters:@{@"rid":@"showStudentForPartSec",@"userid":@"2015051212"} success:^(NSURLSessionDataTask * _Nullable task, id  _Nullable responseObject) {
