...
@interface SchoolRecruitViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SchoolRecruitViewController
...
-(void)loadDataPageNum:(int )page
{
    ...
    [NetworkCore requestPOST:[AppUserIndex GetInstance].API_URL parameters:@{@"rid":@"showRecruitByInput",@"type":@"0", @"page":@(page),@"pageCount":Message_Num} success:^(NSURLSessionDataTask * _Nullable task, id  _Nullable responseObject) {
        [ProgressHUD dismiss];
