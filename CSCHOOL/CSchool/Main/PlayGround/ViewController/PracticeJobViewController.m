...
@interface PracticeJobViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation PracticeJobViewController
...
-(void)loadDataPageNum:(int )page
{
    ...
    [NetworkCore requestPOST:[AppUserIndex GetInstance].API_URL parameters:@{@"rid":@"showRecruitByInput",@"type":@"2", @"page":@(page),@"pageCount":Message_Num} success:^(NSURLSessionDataTask * _Nullable task, id  _Nullable responseObject) {
        [ProgressHUD dismiss];
