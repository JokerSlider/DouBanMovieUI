...
@interface OAChoseViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation OAChoseViewController
...
-(void)batchData
{
    ...
    if (self.mainTableView.editing) {
        //将存着ID的数组传递给下一个界面
        //跳转到填写意见界面
        if (self.OAChooseListBlock) {
            self.OAChooseListBlock(_editArr);
        }
