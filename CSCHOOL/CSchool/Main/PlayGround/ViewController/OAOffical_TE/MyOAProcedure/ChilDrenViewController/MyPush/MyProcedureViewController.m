...
@interface MyProcedureViewController ()<UITableViewDelegate,UITableViewDataSource,JSDropDownMenuDataSource,JSDropDownMenuDelegate>
{
...
@implementation MyProcedureViewController
...
-(void)loadDatawithPage:(int)page
{
    ...
    [NetworkCore requestMD5POST:url parameters:@{@"in_state":@"1",@"in_fi_id":_fi_id,@"in_yhbh":OATeacherNum,@"scode":[AppUserIndex GetInstance].schoolCode,@"begin_num":pageString,@"num":Message_Num,@"in_sp_state":@"1",@"flag":@"in_state,in_fi_id,in_yhbh,scode,begin_num,num,in_sp_state"} success:^(NSURLSessionDataTask * _Nullable task, id  _Nullable responseObject) {
        [ProgressHUD dismiss ];
