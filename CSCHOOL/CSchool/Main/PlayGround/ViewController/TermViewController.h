...
@interface TermViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,TermCellDelegate,UIPickerViewDataSource,UIPickerViewDelegate,XGAlertViewDelegate>
{
