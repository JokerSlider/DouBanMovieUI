//
//  EmAllPersonNumViewController.m
//  CSchool
//
...
#import "TePopList.h"
#import "ExamModel.h"
@interface EmAllPersonNumViewController ()<UITableViewDelegate,UITableViewDataSource,XGAlertViewDelegate,CNContactViewControllerDelegate,ABNewPersonViewControllerDelegate>
{
        ...
        NSArray *_telPhoneArr;//用于弹窗的电话数组
...
@implementation EmAllPersonNumViewController
