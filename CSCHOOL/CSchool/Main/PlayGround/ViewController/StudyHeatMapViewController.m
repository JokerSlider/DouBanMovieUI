//
//  StudyHeatMapViewController.m
//  CSchool
//
//  Created by 左俊鑫 on 2017/8/23.
...
@interface StudyHeatMapViewController ()
...
@implementation StudyHeatMapViewController
...
{
    [super viewDidLoad];
    [AMapServices sharedServices].apiKey = [NSString stringWithFormat:@"5137fcb4d6c0f296636cde19e04fa725"];
...
- (void)initHeadMapTileOverLay {
    ...
    if (jsdata)
    {
        ...
        for (NSDictionary *dic in array)
        {
            ...
            node.intensity = [dic[@"count"] integerValue];
            [data addObject:node];
        }
    }
