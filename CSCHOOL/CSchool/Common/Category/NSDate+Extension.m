...
+(NSString *)dateTranlateStringFromTimeString:(NSString *)timeString andformatterString:(NSString *)formatterString
{
    NSDateFormatter* formatter = [[NSDateFormatter alloc] init];
    formatter.timeZone = [NSTimeZone defaultTimeZone];
    NSInteger num = [timeString doubleValue]/1000;//（重点）
...
+(NSString *)tranlateDateString:(NSString *)timeString andFormatStr:(NSString *)formatString
{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    ...
    NSDate *date = [NSDate dateWithString:timeString format:formatString];
    NSInteger timeSp = [[NSNumber numberWithDouble:[date timeIntervalSince1970]] integerValue];
    NSString *timeSPString = [NSString stringWithFormat:@"%ld",(long)timeSp];
    return timeSPString;
}
+(NSString *)tranlateOldDateTimeString:(NSDate *)oldtime withOldFormat:(NSString *)oldFormat  andNewformat:(NSString *)newFormat{
    
    NSDateFormatter *inputFormatter= [[NSDateFormatter alloc] init];
    [inputFormatter setLocale:[[NSLocale alloc] initWithLocaleIdentifier:@"en_US"]];
    [inputFormatter setDateFormat:oldFormat];
    NSDate *inputDate =oldtime;
    NSDateFormatter *outputFormatter= [[NSDateFormatter alloc] init];
    [outputFormatter setLocale:[NSLocale currentLocale]];
    [outputFormatter setDateFormat:newFormat];
    NSString *newStr= [outputFormatter stringFromDate:inputDate];
    
    return newStr;
}
+(NSString *)tranlateOldTimeString:(NSString *)oldtimeStr withOldFormat:(NSString *)oldFormat  andNewformat:(NSString *)newFormat{

    NSString *string = oldtimeStr;
    NSDateFormatter *inputFormatter= [[NSDateFormatter alloc] init];
    [inputFormatter setLocale:[[NSLocale alloc] initWithLocaleIdentifier:@"en_US"]];
    [inputFormatter setDateFormat:oldFormat];
